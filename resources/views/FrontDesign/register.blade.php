...
<input name="name" value="{{old('name')}}" class="form-control" type="text" id="reg-fn" >
@error('name')
...
<input name="email" value="{{old('email')}}" class="form-control" type="email" id="reg-email" >
@error('email')
<div class="text text-danger"> {{$message}} </div>
@enderror
</div>
...
<input name="phone" value="{{old('phone')}}" class="form-control" type="text" id="reg-phone" >
@error('phone')
<div class="text text-danger"> {{$message}} </div>
@enderror
</div>
...
<input name="password_confirmation" class="form-control" type="password" id="reg-pass-confirm" >
...
<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script><script src="{{url('assets/js/bootstrap.min.js')}}"></script>
